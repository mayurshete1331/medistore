...
public class DataInitializer implements CommandLineRunner {
        ...
        public void seedAllData() {
                ...
                createUserIfAbsent("Dr. Sneha Roy, MBBS, MD", "dr.sneha@clinic.org", defaultPass, "DOCTOR",
                                ...
                                "MMC-2016-89421", "Internal Medicine & Chronic Care",
                                "Roy Medical Chambers, Suite 204, Mumbai", null);

                createUserIfAbsent("Dr. Rajesh Sharma, MD (Cardiology)", "dr.sharma@heartcare.org", defaultPass,
                                "DOCTOR",
                                "+91 98203 11229", "❤️‍🩹", null, null,
                                "MMC-2012-45211", "Cardiologist & Hypertension Specialist",
                                "Apex Heart Institute, Sector 15, Thane", null);

                createUserIfAbsent("Dr. Priya Patel, MBBS, DCH (Pediatrics)", "dr.priya@childhealth.org", defaultPass,
                                "DOCTOR",
                                "+91 98111 22334", "👶", null, null,
                                "MMC-2018-77123", "Consultant Pediatrician & Neonatologist",
                                "Little Stars Children Clinic, Kothrud, Pune", null);

                // --- 5 Customers ---
                createUserIfAbsent("Vikram Malhotra", "vikram.m@gmail.com", defaultPass, "CUSTOMER",
                                "+91 98199 44332", "👤", null, null,
                                null, null, null,
                                "Flat 402, Green Meadows Tower, Link Road, Andheri West, Mumbai 400053");
                ...
                seedMedicineIfAbsent("Augmentin 625 Duo", "Amoxicillin (500mg) + Clavulanic Acid (125mg)", "Tablet",
                                "GlaxoSmithKline Pharmaceuticals", "30041010", 12, "10 Tablets/Strip", 10, "Tab",
                                "Rack A-01",
                ...
                seedMedicineIfAbsent("Telma 40", "Telmisartan (40mg)", "Tablet",
                                "Glenmark Pharmaceuticals Ltd", "30049099", 12, "15 Tablets/Strip", 15, "Tab",
                                "Rack C-01",
                ...
                seedMedicineIfAbsent("Shelcal 500", "Calcium (500mg) + Vitamin D3 (250 IU)", "Tablet",
                                "Torrent Pharmaceuticals Ltd", "30045090", 12, "15 Tablets/Strip", 15, "Tab",
                                "Rack D-01",
                                false, false, false, 35, 70, "SHL-902", "2024-01", "2026-06", 92.0, 131.0, 125.0, 65);

                seedMedicineIfAbsent("Ascoril D Plus Syrup", "Dextromethorphan + Phenylephrine + Chlorpheniramine",
                                "Syrup",
                                "Glenmark Pharmaceuticals Ltd", "30049080", 12, "100ml Bottle", 1, "Bottle",
                                "Rack S-02",
                ...
                seedMedicineIfAbsent("Lantus SoloStar Pen", "Insulin Glargine (100IU/ml)", "Injection",
                                "Sanofi India Ltd", "30043110", 5, "3ml Cartridge Pen", 1, "Pen",
                                "Cold Storage Chiller-1",
        ...
        private void seedSampleInvoices() {
                ...
                if (doloBatch == null || panBatch == null)
                        return;
        ...
        private void seedAffiliations() {
                ...
                affiliateUserIfAbsent(1L, "dr.sneha@clinic.org", "DOCTOR", "Rajesh Patel",
                                "Primary Partner Prescribing Doctor");
                affiliateUserIfAbsent(1L, "vikram.m@gmail.com", "CUSTOMER", "Rajesh Patel",
                                "Regular Khata Credit Customer");
                affiliateUserIfAbsent(1L, "sunita.sharma@yahoo.co.in", "CUSTOMER", "Rajesh Patel",
                                "Senior Citizen Healthcare Member");

                // Store 2 (HealthFirst Chemist)
                affiliateUserIfAbsent(2L, "dr.priya@childhealth.org", "DOCTOR", "Amit Shah",
                                "Consultant Pediatrician Partner");
                affiliateUserIfAbsent(2L, "rahul.verma@gmail.com", "CUSTOMER", "Amit Shah",
                                "Chronic Diabetes Refill Customer");

                // Store 3 (Apex LifeLine)
                affiliateUserIfAbsent(3L, "dr.sharma@heartcare.org", "DOCTOR", "Suresh Deshmukh",
                                "Cardiology Clinic Referral Partner");
                affiliateUserIfAbsent(3L, "ananya.iyer@outlook.com", "CUSTOMER", "Suresh Deshmukh",
                                "Corporate Health Plan Client");
                affiliateUserIfAbsent(3L, "deepak.k@gmail.com", "CUSTOMER", "Suresh Deshmukh",
                                "Thane West Local Resident");
        }
